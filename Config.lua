...
Config = {
	...
	-- DIFFICULTY 
	BotAimWorsening = 0.8,				-- Make bots aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	BotSniperAimWorsening = 1,		-- See botAimWorsening, only for Sniper-rifles 
	BotSupportAimWorsening = 1,		-- See botAimWorsening, only for LMGs 
	BotWorseningSkill = 0.2,			-- Variation of the skill of a single bot. The higher, the worse the bots can get compared to the original settings 
	BotSniperWorseningSkill = 0.2,		-- See BotWorseningSkill - only for BOTs using sniper bolt-action rifles 
	ReactionTime = 0.8,					-- Additional delay for bots, dependant of skill (might also be 0) 
	...
	DamageFactorShotgun = 0.3,			-- Original Damage from bots gets multiplied by this 
	DamageFactorPistol = 0.5,			-- Original Damage from bots gets multiplied by this 
	...
	AdditionalBotSpawnDelay = 1.5,		-- Additional time a bot waits to respawn 
	...
	-- BEHAVIOUR 
	FovForShooting = 90,				-- Degrees of FOV of Bot 
	...
	MaxShootDistanceSniper = 70,		-- Meters before bots will start shooting at players 
	MaxShootDistanceMissileAir = 350,	-- Meters before bots will start shooting with stingers 
	MaxDistanceShootBack = 70,			-- Meters until bots (not sniper) shoot back if hit 
	MaxDistanceShootBackSniper = 70,	-- Meters until snipers shoot back if hit 
	MaxShootDistancePistol = 40,		-- The distance before a bot switches to pistol if his magazine is empty (Only in auto-weapon-mode) 
	...
	FovVehicleForShooting = 90,		-- Degrees of FOV of Non AA - Vehicles 
	...
	MeleeAttackCoolDown = 1,			-- The time a bot waits before attacking with melee again 
	...
	SpeedFactorAttack = 0.8,			-- Reduces the movement speed while attacking. 1 = normal, 0 = standing 
	SpeedFactorVehicleAttack = 0.8,		-- Reduces the movement speed while attacking in vehicles. 1 = normal, 0 = standing 
